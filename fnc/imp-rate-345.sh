calc-345(){
    ...
    # make ID info and map ready. see groups.sh for column names
    ...
    ############################################################
    # Find ID only with HD genotypes, put them to Beagle format
    ...
    ############################################################
    echo Gether HD genotypes of the 345 ID
}
